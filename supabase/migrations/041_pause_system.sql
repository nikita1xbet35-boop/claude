...
-- (передеплой #2: Supabase Management API сам отдавал 524 timeout несколько
-- попыток подряд — 035-037/039 уже применились раньше, 038/040/041 всё ещё
-- нет. Эта правка снова только триггерит новый
-- пуш, содержимое не менялось)
--
