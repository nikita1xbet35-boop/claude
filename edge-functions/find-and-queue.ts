...
const DEFAULT_PRESETS: Record<string, Preset[]> = {
  '1xbet': [
    { id:'1xb-ng', name:'Nigeria', geo:'NG',
      keywords:["betting affiliate nigeria","1xbet partner nigeria","nigeria betting blog","betting influencer nigeria","naija betting tips","sure prediction nigeria","betting promo code nigeria","casino bonus codes nigeria","gambling guest post nigeria","sports prediction blog nigeria","betting odds review nigeria"] },
    ...
    { id:'1xb-kg', name:'Kyrgyzstan', geo:'KG',
      keywords:["букмекерский партнер","бонусы казино промокод","прогнозы на спорт блог","ставки блог обзор","беттинг блог снг","казино бонус кыргызстан","прогнозы экспресс","обзор ставок кыргызстан"] },
    ...
    { id:'1xb-ph', name:'Philippines', geo:'PH',
      keywords:["betting affiliate philippines","pinoy betting blog","casino bonus philippines","aviator prediction philippines","sabong tips site","betting promo philippines","gambling blog philippines","sports prediction pinoy","online casino guide philippines"] },
    { id:'1xb-np', name:'Nepal', geo:'NP',
      keywords:["betting affiliate nepal","nepal betting blog","cricket prediction nepal site","casino bonus nepal","betting tips nepal blog","sports prediction nepal","ipl prediction nepal","gambling guest post nepal"] },
    { id:'1xb-pk', name:'Pakistan', geo:'PK',
      keywords:["betting affiliate pakistan","pakistan betting blog","cricket prediction pakistan site","casino bonus pakistan","aviator prediction pakistan","betting tips pakistan blog","psl prediction site","crash game tips pakistan","urdu betting blog"] },
    { id:'1xb-in', name:'India', geo:'IN',
      keywords:["betting affiliate india","india betting blog","cricket prediction india site","ipl prediction blog","casino bonus india","aviator prediction india","teen patti blog","sure betting tips india","gambling guest post india","betting influencer india"] },
    { id:'1xb-bd', name:'Bangladesh', geo:'BD',
      keywords:["betting affiliate bangladesh","bangladesh betting blog","cricket prediction bangladesh","casino bonus bangladesh","bpl prediction site","betting tips bangladesh blog","aviator prediction bangladesh","gambling guest post bangladesh"] },
    { id:'1xb-ar', name:'Argentina', geo:'AR',
      keywords:["afiliados casino argentina","casino blog argentina","pronosticos deportivos argentina","aviator predicción argentina","bono casino argentina codigo","tips apuestas argentina","blog apuestas deportivas argentina","influencer apuestas argentina"] },
    { id:'1xb-cl', name:'Chile', geo:'CL',
      keywords:["afiliados casino chile","casino blog chile","pronosticos deportivos chile","aviator predicción chile","bono casino chile codigo","tips apuestas chile","blog apuestas chile"] },
    { id:'1xb-ci', name:'Côte d\'Ivoire', geo:'CI',
      keywords:["affilié casino côte d'ivoire","blog paris sportifs CIV","pronostic foot abidjan","aviator prédiction côte d'ivoire","bonus casino CIV code","conseils paris CIV","blog casino abidjan"] },
    { id:'1xb-bf', name:'Burkina Faso', geo:'BF',
      keywords:["affilié casino burkina","blog paris sportifs burkina","pronostic foot ouagadougou","aviator prédiction burkina","bonus casino burkina code","conseils paris burkina"] },
    { id:'1xb-sn', name:'Senegal', geo:'SN',
      keywords:["affilié casino sénégal","blog paris sportifs dakar","pronostic foot sénégal","aviator prédiction sénégal","bonus casino sénégal code","conseils paris sénégal"] },
    { id:'1xb-cm', name:'Cameroun', geo:'CM',
      keywords:["affilié casino cameroun","blog paris sportifs douala","pronostic foot cameroun","aviator prédiction cameroun","bonus casino cameroun code","conseils paris cameroun"] },
    { id:'1xb-ma', name:'Morocco', geo:'MA',
      keywords:["affilié casino maroc","blog paris sportifs maroc","pronostic foot maroc","aviator prédiction maroc","bonus casino maroc code","كازينو بونص المغرب","نصائح الرهان المغرب"] },
    { id:'1xb-za', name:'South Africa', geo:'ZA',
      keywords:["betting affiliate south africa","south africa betting blog","sports prediction SA site","casino bonus south africa","aviator prediction SA","betting tips SA blog","rugby betting tips","gambling guest post SA"] },
    ...
    { id:'1xb-mm', name:'Myanmar', geo:'MM',
      keywords:["casino affiliate myanmar","myanmar betting blog","aviator prediction myanmar","casino bonus myanmar","sports prediction myanmar","betting tips myanmar blog"] },
